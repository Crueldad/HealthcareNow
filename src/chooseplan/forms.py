...
class chooseplanform(forms.ModelForm):
    class Meta:
        ...
        'Level_of_excerise': forms.RadioSelect, 'Do_you_smoke': forms.RadioSelect, 'Do_you_take_non_presribed_drugs': forms.RadioSelect, 'Do_you_often_participate_in_sports': forms.RadioSelect, 'Do_you_have_a_labor_intensive_job': forms.RadioSelect}
